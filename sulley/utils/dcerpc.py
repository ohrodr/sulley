...
def request(opnum, data):
    """Return a list of packets as 5k fragmented chunks necessary to make the RPC request."""
    ...
    # you don't have to send chunks out individually. so make life easier send them all at once.
    return "".join(frags)
