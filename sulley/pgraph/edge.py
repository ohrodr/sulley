...
class edge(object):
    ...
    def __init__(self, src, dst):
        ...
        """
        # the unique id for any edge (provided that duplicates are not allowed) is the
        # combination of the source and the destination stored as a long long.
        self.id = (src << 32) + dst
        self.src = src
        self.dst = dst
    ...
    def render_edge_graphviz(self, graph):
        ...
        # no need to validate if nodes exist for src/dst. graphviz takes care of that transparently.
    ...
    def render_edge_udraw_update(self):
        """Render an edge update description suitable for use in a GML file using internal attributes.
